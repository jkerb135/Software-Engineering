...
<asp:Content ID="Content2" ContentPlaceHolderID="SiteBody" runat="server">
            ...
            <ContentTemplate>
                <div class="panel-body" id="catBody" >
                    <div style="overflow: auto; max-height: 250px;">
                        ...
                        <asp:GridView ShowHeaderWhenEmpty="true" EmptyDataText="No Pending Category Requests from other Supervisors" DataSourceID="RequestSource" DataKeyNames="CategoryName" ID="requests" CssClass="table table-hover table-striped" GridLines="None" runat="server" AllowPaging="True" AutoGenerateColumns="false" OnRowCommand="users_RowCommand">
                            <Columns>
    ...
    <div class="panel panel-primary" id="taskRequests">

        <div class="panel-heading" style="cursor:pointer">
            <i class="fa fa-users fa-fw"></i>
            <asp:Label ID="Label3" runat="server" Text="Your Task Requests"></asp:Label>
            <i class="fa fa-arrow-down right" id="taskDir"></i>
        </div>
            ...
            <ContentTemplate>
                <div class="panel-body" id="taskBody">
                    <div style="overflow: auto; max-height: 250px;">
                        ...
                        <asp:GridView ShowHeaderWhenEmpty="true" EmptyDataText="No Pending Task Requests from other Supervisors" DataSourceID="RequestSource" DataKeyNames="CategoryName" ID="TaskGrid" CssClass="table table-hover table-striped" GridLines="None" runat="server" AllowPaging="True" AutoGenerateColumns="false" OnRowCommand="users_RowCommand">
                            <Columns>
                                <asp:BoundField DataField="CategoryID" HeaderText="ID" />
                                <asp:BoundField DataField="CategoryName" HeaderText="Category Name"/>
                                <asp:BoundField DataField="RequestingUser" HeaderText="Requesting User"/>
