...
using iPaws.Models.Mapping;

namespace iPaws.Models
{
    public partial class ipawsTeamBContext : DbContext
    {
        static ipawsTeamBContext()
        {
            Database.SetInitializer<ipawsTeamBContext>(null);
        }

        public ipawsTeamBContext()
            : base("Name=ipawsTeamBContext")
        {
        }
